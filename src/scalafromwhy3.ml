...
(** Printer for extracted Scala code *)

(** Mere copy of src/extract/ocaml.ml for the moment. TO BE UPDATED. *)
...
let scala_printer = Pdriver.{
    desc = "printer for Scala code";
    implem_printer = {
        filename_generator = ng ".scala";
...
let () = Pdriver.register_printer "scala" scala_printer
